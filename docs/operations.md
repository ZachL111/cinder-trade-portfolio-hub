...
`cinder-trade-portfolio-hub` is centered on trading systems work in Zig. The technical target is: Design a Zig verification harness for portfolio systems, covering simulation kernel, seeded input scenarios, and failure-oriented tests.
...
The score is deterministic. The current threshold is 158. Risk has a penalty of 6, latency has a penalty of 2, and weight contributes a bonus of 6.
